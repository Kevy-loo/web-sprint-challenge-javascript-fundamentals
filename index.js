...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// Nested function can access the variable internal because it is a innner function grabbing the variable internal. If my function was trying to grab a variable that is defined in nested function it would not work and would give you an error.
...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(arr){
    const newarr = arr.filter(item => item.population < 5);
    return newarr;
  }
  ...
  */
  ...
  function USApop(arr){
    const total = arr.reduce((acc, item) => acc + item.population, 0);
    return total
  }
